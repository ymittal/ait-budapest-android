...
public class SettingsDialog extends AppCompatActivity {
    ...
    private void checkForChanges() {
        if (MinesweeperModel.SIZE != npSize.getValue()
                || MinesweeperModel.NUM_MINES != npFlags.getValue()) {
    ...
    private void initFlagsHalf() {
        ...
        npFlags.setValue(MinesweeperModel.NUM_MINES);
    ...
    private void initSizeHalf() {
        ...
        npSize.setValue(MinesweeperModel.SIZE);
